...
describe("User Routes", () => {
      ...
      const response = await request(app)
        ...
        it('should return 409 if user already exists', async () => {
          const existingUser = {
                ...
                type: "Association",
                description: "Nous aidons les personnes victimes de phénomènes d’exclusion, les solutions qui leur permettent de redevenir acteur de leur vie",
  ...
  it('should sign up a new user', async () => {
    const newUser = {
       ...
       name:"Citadium",
        ...
        type:"Entreprise",
   description: "Nous sommes spécialisés dans la vente au détail de vêtements, chaussures et accessoires",
          phone_number: "04.93.94.01.77",
          url_site: null,
          logo: null,
        longitude:43.305591,
  ...
  it("should reset user password", async () => {
    ...
    const response = await request(app)
      ...
      .send({ email: "life@life.com", username: "Léna ", password: newPassword });
